...
export const ca = {
    ...
    admin: {
        ...
        promos: {
            title: "Codis Promocionals",
            desc: "Administra codis de descompte, els seus límits d'ús i dates d'expiració.",
            create_title: "Crear Codi Promocional",
            placeholder_code: "CODI (Ex: ESTIU20)",
            placeholder_discount: "Ex: 15",
            discount_label: "Descompte (%)",
            max_uses_label: "Límit d'Usos (Opcional)",
            max_uses_placeholder: "Ilimitats si es deixa buit",
            expiry_label: "Data d'Expiració (Opcional)",
            create_btn: "Crear Codi",
            table_code: "Codi",
            table_discount: "Descompte",
            table_uses: "Usos",
            table_expiry: "Expiració",
            table_status: "Estat",
            table_actions: "Accions",
            no_expiry: "Sense expiració",
            status_active: "Actiu",
            status_inactive: "Inactiu",
            status_expired: "Expirat",
            status_exhausted: "Esgotat",
            confirm_delete: "Estàs segur que vols eliminar aquest codi promocional?",
            error_fetching: "Error al carregar els codis promocionals.",
            error_empty_code: "El codi no pot estar buit.",
            error_invalid_discount: "El descompte ha d'estar entre 1 i 100.",
            error_invalid_max_uses: "El límit d'usos ha de ser un número positiu.",
            success_create: "Codi promocional creat amb èxit.",
            error_create: "Error en crear el codi promocional.",
            error_server: "S'ha produït un error en connectar amb el servidor.",
            error_status: "Error en canviar l'estat.",
            error_delete: "Error en eliminar.",
            loading_codes: "Carregant codis...",
            tooltip_toggle: "Feu clic per activar/desactivar",
            tooltip_delete: "Eliminar codi",
            no_promos: "No hi ha codis promocionals."
        }
    },
    cart: {
